...
<HTML>
<HEAD>
<TITLE> Bacteria Genomes Levels </TITLE>
...
<TABLE id=main cellSpacing=3 cellPadding=5 width=757 align=center border=0 height="135">
  ...
  <TR vAlign=top>
    ...
    <TD width=644 height="80"><font face="Arial, Helvectica, sans-serif" size="6"><b>Groups of Bacteria <I><U><FONT COLOR="#800000">Genomes</U></I></FONT>  Levels </b></font><BR><br>            
<% java.util.Date date = new java.util.Date(); %>
  ...
  <TR vAlign=top><TD colSpan=2 width="737" height="5">
	  ...
	  <font size="1">&gt;&gt;&nbsp; <a href="blevels.jsp">Bacteria Genomes Levels</a>&nbsp;</font>
...
<FORM action="blevels.jsp" method="post">
<tr><td align=center>
<FONT COLOR="#800000" face="Arial, Helvectica, sans-serif" size="5"><i>Groups of Bacteria Genomes Levels</I></FONT>
</td></tr>
<tr>
<td align=right><FONT face="Arial, Helvetica, sans-serif" size="2">Select Levels :</font> 
                    <SELECT name=level style="border: 1 solid #0099FF"> size="1">
					          <OPTION selected  
								...
								value=11>11  <OPTION
								value=12>12  <OPTION
                                value=13>13  </OPTION></SELECT>&nbsp;&nbsp;&nbsp;&nbsp;<INPUT type=submit value=Submit>
...
<table cellSpacing=3 cellPadding=5 width=550 align=center border=0 >
